...
class Cohort
  ...
  LAST_COFFEE_CODE_WEEK = 12 # changed since we're in a 12 week course!
  WEEKS_IN_COHORT = 12 # changed since we're in a 12 week course!
...
# Holiday gem info - https://github.com/holidays/holidays

megazord = Cohort.new(Date.new(2018,7,9))
p megazord.last_day # => Friday September 28th, 2018
p megazord.coffee_code_days # => Shows every Tues and Thurs in the course
p megazord.class_days # => Shows every day in the course
